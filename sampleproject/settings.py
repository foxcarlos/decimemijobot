...
ALLOWED_HOSTS = ["decimemijobot-foxcarlos756841.codeanyapp.com"]
...
CRIPTO_MONEDAS = {
        ...
        "URL_PRICE_USD_EUR_MARKET": "https://min-api.cryptocompare.com/data/price?fsym={0}&tsyms=USD,EUR&e={1}&"
        }
